    ...
    <section className="bg-neutral-950 p-6 md:p-8">
      <div className="mx-auto max-w-5xl ">
        <Link
          ...
          imgSrc="src/assets/Who am I.jpeg"
        ...
        <Link
          ...
          imgSrc="src/assets/FOCUS.jpeg"
          href="https://myportfolio-7e2c3.web.app/"
        />
        <Link
          heading="Careers"
          subheading="Unemployed BTW ;)"
          imgSrc="src/assets/_.jpeg"
          href="#"
        />
        <Link
          heading="Fun"
          subheading="Incase you're bored"
          imgSrc="src/assets/Julio Cesar.jpeg"
  ...
  return (
    ...
    >
      ...
      <motion.img
        ...
        transition={{ type: "spring" }}
        src={imgSrc}
        className="absolute z-0 h-24 w-32 rounded-lg object-cover md:h-47 md:w-64"
